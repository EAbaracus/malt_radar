...
void main() {
  ...
  const mockCsv = '''record_id,record_type,canonical_name,whisky_name,distillery,brand_or_company,country,region,origin_raw,type,class,age_years,age_raw,abv_percent,bottle_size,cask_type,finish_type,smoke_level,peat_level,sweetness,spiciness,body,aroma_tags,nose_notes,palate_notes,finish_notes,pairing_notes,general_notes,user_score_100,meta_critic
WDB-00001,whisky_product,Test Whisky,wname,Test Distillery,brand,Scotland,Speyside,origin,Malt,SingleMalt-like,12,12y,40,70cl,Bourbon Cask,finish,smoke,peat,sweet,spice,body,aroma,Apple,Honey,Oak,pairing,general,85,90
WDB-00002,whisky_product,Test Whisky 2,wname2,Test Distillery 2,brand2,Scotland,Islay,origin2,Malt,SingleMalt-like,NAS,nas,46,70cl,Sherry Cask,finish2,smoke2,peat2,sweet2,spice2,body2,aroma2,Smoke,Peat,Ash,pairing2,general2,90,95
''';
  ...
  test('DataSeedService reads mock CSV and populates DB', () async {
    ...
    expect(first.category, 'SingleMalt-like');
    expect(first.age, 12);
