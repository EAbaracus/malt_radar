# GSD Candidate: Kavalan Conductor
**Candidate ID:** GSD-CAND-0088
...
## 1. Product Identity
- Canonical Name: Kavalan Conductor
- Display Name: Kavalan Conductor
- Distillery: Kavalan
- Brand: 
- Country: Taiwan
- Region: Taiwanese
- Type: Malt
- Product Line: 
- Iconic Reason: Blend of Kavalan casks; tests multi-cask Taiwan expression vs single cask peers
