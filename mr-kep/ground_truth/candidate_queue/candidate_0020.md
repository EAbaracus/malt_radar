# GSD Candidate: Kilchoman Machir Bay
**Candidate ID:** GSD-CAND-0020
...
## 1. Product Identity
- Canonical Name: Kilchoman Machir Bay
- Display Name: Kilchoman Machir Bay
...
- Type: Malt
- Product Line: 
- Iconic Reason: Farm distillery NAS; youngest Islay distillery; tests NAS peated expression
