# GSD Candidate: Balvenie Caribbean Cask 14yo
**Candidate ID:** GSD-CAND-0016
**Status:** PENDING_REVIEW
**Benchmark Split Target:** validation
**Certification Tier Target:** Silver
...
## 1. Product Identity
- Canonical Name: Balvenie Caribbean Cask 14yo
- Display Name: Balvenie Caribbean Cask 14 Year Old
- Distillery: Balvenie
- Brand: 
- Country: Scotland
- Region: Speyside
- Type: Malt
- Product Line: 
- Iconic Reason: Tests rum-finish cask type identification; same distillery as 0008 for consistency
