# GSD Candidate: Laphroaig Quarter Cask
**Candidate ID:** GSD-CAND-0018
...
## 1. Product Identity
- Canonical Name: Laphroaig Quarter Cask
- Display Name: Laphroaig Quarter Cask
...
- Type: Malt
- Product Line: 
- Iconic Reason: Quarter-cask NAS; tests small-cask terminology extraction
