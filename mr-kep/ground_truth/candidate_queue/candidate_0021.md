# GSD Candidate: Bruichladdich Classic Laddie
**Candidate ID:** GSD-CAND-0021
...
## 1. Product Identity
- Canonical Name: Bruichladdich Classic Laddie
- Display Name: Bruichladdich The Classic Laddie
...
- Type: Malt
- Product Line: 
- Iconic Reason: Unpeated Islay NAS; tests unpeated Islay (minority profile) extraction
