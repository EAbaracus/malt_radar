# GSD Candidate: Kavalan Classic Single Malt
**Candidate ID:** GSD-CAND-0087
...
## 1. Product Identity
- Canonical Name: Kavalan Classic Single Malt
- Display Name: Kavalan Classic Single Malt
- Distillery: Kavalan
- Brand: 
- Country: Taiwan
- Region: Taiwanese
- Type: Malt
- Product Line: 
- Iconic Reason: Entry-level Kavalan; NAS standard bottling; tests accessible Taiwan extraction
