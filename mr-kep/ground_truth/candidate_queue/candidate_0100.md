# GSD Candidate: Starward Solera
**Candidate ID:** GSD-CAND-0100
...
## 1. Product Identity
- Canonical Name: Starward Solera
- Display Name: Starward Solera Single Malt
- Distillery: Starward
- Brand: 
- Country: Australia
- Region: Australian
- Type: Malt
- Product Line: 
- Iconic Reason: Solera-method Australian malt; tests solera process and Apera cask terminology
...
- Vintage Year:
- Bottling Year:
- Cask Type: Apera (Australian Sherry)
- Secondary Cask Type:
- Bottle Size (ml):
- Colorant Added:
- Chill Filtered:
