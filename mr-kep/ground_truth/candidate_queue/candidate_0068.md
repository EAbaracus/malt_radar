# GSD Candidate: Redbreast 15yo
**Candidate ID:** GSD-CAND-0068
...
## 1. Product Identity
- Canonical Name: Redbreast 15yo
- Display Name: Redbreast 15 Year Old Single Pot Still
- Distillery: Midleton
- Brand: 
- Country: Ireland
- Region: Dublin
...
- Product Line: 
- Iconic Reason: Older SPS; same distillery as 0067; tests cross-age Irish SPS extraction
