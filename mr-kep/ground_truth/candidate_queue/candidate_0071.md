# GSD Candidate: Teeling Single Malt
**Candidate ID:** GSD-CAND-0071
...
## 1. Product Identity
- Canonical Name: Teeling Single Malt
- Display Name: Teeling Single Malt Irish Whiskey
- Distillery: Teeling
- Brand: 
- Country: Ireland
- Region: Dublin
- Type: Malt
- Product Line: 
- Iconic Reason: Modern Dublin distillery; unusual cask mix; tests rum+wine multi-cask extraction
