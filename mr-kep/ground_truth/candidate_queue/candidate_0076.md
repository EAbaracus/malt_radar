# GSD Candidate: Teeling Small Batch
**Candidate ID:** GSD-CAND-0076
...
## 1. Product Identity
- Canonical Name: Teeling Small Batch
- Display Name: Teeling Small Batch Irish Whiskey
- Distillery: Teeling
- Brand: 
- Country: Ireland
- Region: Dublin
- Type: Blend
- Product Line: 
- Iconic Reason: Entry-level Teeling blend; rum-cask finish; tests blend vs malt same-distillery
