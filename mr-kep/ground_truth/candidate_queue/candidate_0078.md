# GSD Candidate: Amrut Single Malt
**Candidate ID:** GSD-CAND-0078
...
## 1. Product Identity
- Canonical Name: Amrut Single Malt
- Display Name: Amrut Indian Single Malt
- Distillery: Amrut
- Brand: 
- Country: India
- Region: Karnataka
- Type: Malt
- Product Line: 
- Iconic Reason: Base Indian single malt from same distillery as 0077; consistency check
