# GSD Candidate: Auchentoshan Three Wood
**Candidate ID:** GSD-CAND-0035
...
## 1. Product Identity
- Canonical Name: Auchentoshan Three Wood
- Display Name: Auchentoshan Three Wood
...
- Type: Malt
- Product Line: 
- Iconic Reason: Triple-cask NAS Lowland; tests three-cask description and PX extraction
...
- Vintage Year:
- Bottling Year:
- Cask Type: Bourbon+Sherry+Pedro Ximenez
- Secondary Cask Type:
- Bottle Size (ml):
- Colorant Added:
- Chill Filtered:
