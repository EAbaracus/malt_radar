# GSD Candidate: Penderyn Madeira Finish
**Candidate ID:** GSD-CAND-0091
...
## 1. Product Identity
- Canonical Name: Penderyn Madeira Finish
- Display Name: Penderyn Single Malt Welsh Whisky Madeira Finish
- Distillery: Penderyn
- Brand: 
- Country: Wales
...
- Type: Malt
- Product Line: 
- Iconic Reason: Wales's flagship distillery; Madeira-cask finish; tests exotic cask extraction
