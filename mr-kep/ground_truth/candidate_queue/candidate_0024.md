# GSD Candidate: GlenDronach 12yo
**Candidate ID:** GSD-CAND-0024
...
## 1. Product Identity
- Canonical Name: GlenDronach 12yo
- Display Name: GlenDronach 12 Year Old
...
- Type: Malt
- Product Line: 
- Iconic Reason: Benchmark sherried Highland; all-sherry cask maturation distinctly different from Speyside
