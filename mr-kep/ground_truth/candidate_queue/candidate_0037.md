# GSD Candidate: Ailsa Bay
**Candidate ID:** GSD-CAND-0037
...
## 1. Product Identity
- Canonical Name: Ailsa Bay
- Display Name: Ailsa Bay Sweet Smoke
...
- Type: Malt
- Product Line: 
- Iconic Reason: Modern Lowland peated NAS; tests peat in an atypically non-peated region
