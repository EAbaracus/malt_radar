# GSD Candidate: Green Spot
**Candidate ID:** GSD-CAND-0070
...
## 1. Product Identity
- Canonical Name: Green Spot
- Display Name: Green Spot Single Pot Still
- Distillery: Midleton
- Brand: 
- Country: Ireland
- Region: Dublin
...
- Product Line: 
- Iconic Reason: Spot series entry; pot-still NAS; tests Irish Spot series as a named range
