# GSD Candidate: Aberlour A'bunadh
**Candidate ID:** GSD-CAND-0010
...
## 1. Product Identity
- Canonical Name: Aberlour A'bunadh
- Display Name: Aberlour A'bunadh Batch
- Distillery: Aberlour
- Brand: 
- Country: Scotland
- Region: Speyside
- Type: Malt
- Product Line: 
- Iconic Reason: NAS cask-strength sherry bomb; tests NAS + high ABV + batch variation handling
