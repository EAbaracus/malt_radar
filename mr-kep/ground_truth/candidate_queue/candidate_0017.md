# GSD Candidate: Ardbeg Uigeadail
**Candidate ID:** GSD-CAND-0017
...
## 1. Product Identity
- Canonical Name: Ardbeg Uigeadail
- Display Name: Ardbeg Uigeadail
- Distillery: Ardbeg
- Brand: 
- Country: Scotland
- Region: Islay
- Type: Malt
- Product Line: 
- Iconic Reason: NAS cask-strength peated sherry; tests high ABV + peated + sherry simultaneous
