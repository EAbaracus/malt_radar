# GSD Candidate: Woodford Reserve Distiller's Select
**Candidate ID:** GSD-CAND-0060
...
## 1. Product Identity
- Canonical Name: Woodford Reserve Distiller's Select
- Display Name: Woodford Reserve Distiller's Select
...
- Type: Bourbon
- Product Line: 
- Iconic Reason: Triple-distilled Bourbon; unique method; tests production-method metadata
