...
DRY_RUN_DB_PATH = "output/tmp/low_risk_source_v7_official_facts_dry_run.db"
UPDATE_PLAN_CSV = "data/output/low_risk_source_v7_official_facts_update_plan.csv"
SOURCE_REFS_PLAN_CSV = "data/output/low_risk_source_v7_official_source_references_plan.csv"
DRY_RUN_REPORT_MD = "output/reports/low_risk_source_v7_official_facts_dry_run_report.md"
...
def main():
    ...
    try:
        ...
        # Insert source references with dedup
        existing_fps = set()
    ...
    report = []
    report.append("# Low-Risk Official Facts Batch V7 Dry-Run Report\n")
    ...
    if execution_status.startswith("Success") and integrity_status.lower() == 'ok' and hash_before == hash_after:
        report.append("**GO** (V7 dry-run simulation successfully verified on DB copy).")
    else:
