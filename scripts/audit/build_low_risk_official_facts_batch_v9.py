...
FETCH_CANDIDATES_CSV = os.path.join(OUTPUT_DIR, "low_risk_source_v9_official_facts_fetch_candidates.csv")
READY_CSV = os.path.join(OUTPUT_DIR, "low_risk_source_v9_official_facts_ready_candidates.csv")
UPDATE_PLAN_CSV = os.path.join(OUTPUT_DIR, "low_risk_source_v9_official_facts_update_plan.csv")
SOURCE_REFS_PLAN_CSV = os.path.join(OUTPUT_DIR, "low_risk_source_v9_official_source_references_plan.csv")
MANUAL_REVIEW_CSV = os.path.join(OUTPUT_DIR, "low_risk_source_v9_official_facts_manual_review.csv")
BLOCKED_CSV = os.path.join(OUTPUT_DIR, "low_risk_source_v9_official_facts_blocked.csv")
REPORT_MD = "output/reports/low_risk_source_v9_official_facts_batch_report.md"
...
def main():
    ...
    # Load previously processed whisky_id + field combos (V3 + V5 + V7)
    ...
    report = []
    report.append("# Low-Risk Official Facts Batch V9 Report\n")
    ...
    report.append("\n## Final GO/NO-GO")
    report.append("**GO** (Batch V9 official facts candidate pack built successfully).")

    report.append("\n## Next Phase")
    report.append("- **LOW-RISK-SOURCE-V10 — Guarded Apply Batch 4**: Apply the update_candidate rows and source references to production.")
