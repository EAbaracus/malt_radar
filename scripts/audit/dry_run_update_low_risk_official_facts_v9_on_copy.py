...
DRY_RUN_DB_PATH = "output/tmp/low_risk_source_v9_official_facts_dry_run.db"
...
DRY_RUN_REPORT_MD = "output/reports/low_risk_source_v9_official_facts_dry_run_report.md"
...
def main():
    ...
    report = []
    report.append("# Low-Risk Official Facts Batch V9 Dry-Run Report\n")
    ...
    if execution_status.startswith("Success") and integrity_status.lower() == 'ok' and hash_before == hash_after:
        report.append("**GO** (V9 dry-run simulation successfully verified on DB copy).")
    else:
